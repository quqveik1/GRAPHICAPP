...
struct Slider : Manager 
{
	...
	Slider (Rect _mainRect, double *_num, double _quadrateScale, CLoadManager* _loadManager, int _minNum = 0, int _maxNum = 10, bool _horizontalMode = true, bool _isWhite = false) :
