...
struct AbstractAppData
{
    ...
    virtual int standartWindowDraw (struct Window* window) = 0;
    virtual int standartManagerDraw(struct Manager* manager) = 0;
    virtual int standartManagerOnClick(struct Manager* manager, Vector mp) = 0;
